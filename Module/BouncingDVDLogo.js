export class BouncingDVDLogo{
    ...
    changeColor(){
        const randomDVDColor = '#' + Math.floor(Math.random() * 16777215).toString(16);
        this.DVDLogo.style.fill = randomDVDColor;
    }
}
