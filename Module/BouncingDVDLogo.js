export class BouncingDVDLogo {
  constructor(container, width, height, speed) {
    ...
    this.DVDLogo = document.createElementNS(
    ...
    let dvdPath1 = document.createElementNS(
      "http://www.w3.org/2000/svg",
      "path"
    );
    let dvdPath2 = document.createElementNS(
      "http://www.w3.org/2000/svg",
      "path"
    );
    dvdPath1.setAttribute(
      "d",
